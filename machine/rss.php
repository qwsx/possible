...
<channel>
	...
	<link>http://possible.versatile.fr</link> 
	<description>Possibles</description> 
	<language>fr</language> 
	<image> 
		<title>Possible</title> 
		<url>http://possible.versatile.fr/1517-10.png</url>
		<link>http://possible.versatile.fr</link> 
	</image>
	...
	<item>
		...
		<guid>http://possible.versatile.fr/'.$idDec.'.'.$lan.'</guid>
		<pubDate>'.$date.' +0100</pubDate>
		<description>
			<![CDATA[<p><a href="http://possible.versatile.fr/'.$idDec.'.'.$lan.'" ">#'.$idDec.'<br /><img src="http://possible.versatile.fr/'.mkId(decbin($idDec)).'-30.png" />
			<br /><br /> <img src="http://possible.versatile.fr/'.mkId(decbin($idDec)).'-2.png" /></a> '.$tagPossible[0].''.$by.'
			</p>]]>
		</description>
	</item>';
			} 
